...
const iceButton = document.querySelector("#play-icebreaker");
const soloButton = document.querySelector("#play-solo");
...
function changePageGreen() {
    localStorage.setItem('thema', '아이스브레이킹');
    location.href='beforeStart.html';
}

function changePageYellow() {
    localStorage.setItem('thema', '혼자 놀기');
    location.href='beforeStart.html';
}

iceButton.addEventListener("click", changePageGreen);
soloButton.addEventListener("click", changePageYellow);